...
```
cd existing_repo
git remote add origin https://gitlab.com/pas_smartcitywastemanagement/wastedisposalagencybe.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/pas_smartcitywastemanagement/wastedisposalagencybe/-/settings/integrations)
